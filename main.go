	...
	*/
	...
	for numGeneration <= maxGenerations {
		...
		if bestScore > bestScoreMemory {
			...
			specieEvolution = append(specieEvolution, bestIndividual)
		}
		...
		if bestScore == hammingInNumberOfDigits {
			fmt.Println("========================================================")
			fmt.Println("  SUCCESS!! THE MACHINE FIGURED OUT THE TEXT")
			fmt.Println("========================================================")
			fmt.Println("         ")
			fmt.Println("  REPORT: ")
			fmt.Println("         ")
			fmt.Println("  This is the text generated by the Machine : ", bestIndividual)
			fmt.Printf("  Number of generations needed to achieve the goal: [%d]\n", numGeneration)
			fmt.Println("         ")
			t2 := time.Now().In(loc)
			dif := t2.Sub(t1).Minutes()
			fmt.Println("  Process finished at: ", t2.Format("2006-01-02 15:04:05"))
			fmt.Println("  Elapsed time (in minutes): ", dif)
			fmt.Println("         ")
			fmt.Println("Evolution sequence: ")
			for _, seq := range specieEvolution {
				fmt.Println("  ", seq)
			}
			fmt.Println("========================================================")
			return
